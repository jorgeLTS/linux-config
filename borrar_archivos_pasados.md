# Borrado de archivos mas antiguos
Script que comprueba el número de archivos en un directorio, si en particular los archivos son más de cierto número, elimina el archivo más antiguo, como nota, la eliminacion solo se llevara a cabo si y sólo si, el número de archivos que está por encima de N.

## Secuencia de comandos

Importante: por Favor lea los comentarios, especialmente en `delete_oldest` función.
...
filecount_above_limit(){ 
    ...
    # count is greater than what user specified as max value 
...
main(){ 
    ...
    # to delete_oldest, which removes topmost entry from the sorted list of lines.
...
#Fuente: https://www.enmimaquinafunciona.com/pregunta/80724/borrar-archivo-mas-antiguo-en-un-directorio-cuando-hay-mas-de-7-archivos
```

## Ejemplos de uso
```sh
$ ./this_script.sh  $max_file $PATH
$ ./this_script.sh  8 /home/user
```
